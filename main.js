...
document.getElementById("name_sketch").innerHTML = "Sketch To be Drawn : " + Element_of_array  ; 
...
function updateCanvas(){
    ...
    document.getElementById("name_sketch").innerHTML = "Sketch To be Drawn : " + sketch;
}
...
function setup(){
    ...
    //additional activity which i am doing !!
...
function gotResult(error, results){
    if(error){
        ...
        utter_this =  new SpeechSynthesisUtterance(drawn_sketch);
